...
export const TOKEN_SOURCE_PATTERN = /^(claude-code|opencode|codex|github|pi|ollama-cloud|claude-settings:[a-zA-Z0-9_][a-zA-Z0-9_.-]*)$/;

export const VALID_VALUES = {
  plan: ['max', 'pro', 'team', 'enterprise', 'unknown', 'plus', 'business', 'edu'],
  tokenSource: ['claude-code', 'opencode', 'codex', 'github', 'pi', 'ollama-cloud'], // legacy list; pattern validation used at runtime (claude-code|opencode|codex|github|pi|ollama-cloud|claude-settings:...)
