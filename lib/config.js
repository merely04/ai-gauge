...
export const TOKEN_SOURCE_PATTERN = /^(claude-code|opencode|claude-settings:[a-zA-Z0-9_][a-zA-Z0-9_.-]*)$/;

export const VALID_VALUES = {
  plan: ['max', 'pro', 'team', 'enterprise', 'unknown'],
  tokenSource: ['claude-code', 'opencode'], // legacy list; pattern validation used at runtime
